...
export class GraphImageParser{
	...
	private static SetupParserCanvas() {
	...
	private static ParseGraph(imageData: ImageData, enrolled: number, parsedPoints: number[]) {
		...
		rawBarWidth.forEach(width => widthSum += width);
