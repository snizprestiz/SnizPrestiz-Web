...
export class OverviewGraph extends DpiAwareCanvas{
	...
	public set Data(value: GraphDataByYear[]) {
		this._Data = value.sort((a, b) => a.Year - b.Year);
	...
	public constructor() {
		super();
		this.HMTLElement.classList.add("overviewGraph");
	}
	...
	protected ResizeEvent(): void{
		...
		this.EnrolledMax = Math.max(...this.Data.map((data) => data.Enrolled));
	...
	public Draw(): void{
		...
		let animProgress = Math.sin(animTime * Math.PI / 2);
	...
	protected MouseHoverEvent(hovered: boolean) {
